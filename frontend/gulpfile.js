...
gulp.task("injectLayoutStyles", function () {
  var verticalLightStream = gulp
    .src(["./**/vertical-default-light/**/*.html", "./index.html"])
    .pipe(
      inject(
        gulp.src(["./css/vertical-layout-light/style.css"], { read: false }),
        { relative: true }
      )
    )
    .pipe(gulp.dest("."));
...
gulp.task("copyAddonsScripts", function () {
  ...
  var aScript25 = gulp
    .src(["node_modules/lightgallery/dist/**/*"])
    .pipe(gulp.dest("./vendors/lightgallery"));
  var aScript26 = gulp
    .src(["node_modules/inputmask/dist/jquery.inputmask.bundle.js"])
  ...
  var aScript42 = gulp
    ...
    .pipe(gulp.dest("./vendors/codemirror"));
  var aScript43 = gulp
    .src(["node_modules/quill/dist/quill.min.js"])
  ...
  var aScript57 = gulp
    ...
    .pipe(gulp.dest("./vendors/datatables.net-bs4"));
  var aScript59 = gulp
    .src(["node_modules/owl-carousel-2/owl.carousel.min.js"])
    .pipe(gulp.dest("./vendors/owl-carousel-2"));
  var aScript60 = gulp
    .src(["node_modules/clipboard/dist/clipboard.min.js"])
    .pipe(gulp.dest("./vendors/clipboard"));
  var aScript61 = gulp
    .src(["node_modules/colcade/colcade.js"])
...
gulp.task("copyAddonsStyles", function () {
  ...
  var aStyle42 = gulp
    ...
    .pipe(gulp.dest("./vendors/datatables.net-bs4"));
  var aStyle45 = gulp
    .src(["node_modules/owl-carousel-2/assets/owl.carousel.min.css"])
    .pipe(gulp.dest("./vendors/owl-carousel-2"));
  var aStyle46 = gulp
    .src(["node_modules/owl-carousel-2/assets/owl.theme.default.min.css"])
    .pipe(gulp.dest("./vendors/owl-carousel-2"));
  var aStyle47 = gulp
    .src(["node_modules/owl-carousel-2/assets/owl.video.play.png"])
    .pipe(gulp.dest("./vendors/owl-carousel-2"));
  var aStyle50 = gulp
...
gulp.task("copyMapFiles", function () {
  ...
  var map2 = gulp
    ...
    .pipe(gulp.dest("./vendors/mdi/css"));
  var map3 = gulp
    .src("node_modules/jquery-contextmenu/dist/jquery.contextMenu.min.css.map")
    .pipe(gulp.dest("./vendors/jquery-contextmenu"));
  var map4 = gulp
    .src("node_modules/jquery-contextmenu/dist/jquery.contextMenu.min.js.map")
    .pipe(gulp.dest("./vendors/jquery-contextmenu"));
  var map5 = gulp
    .src(
  ...
  var map9 = gulp
    ...
    .pipe(gulp.dest("./vendors/jquery-asGradient"));
  var map10 = gulp
    .src("node_modules/quill/dist/quill.min.js.map")
    .pipe(gulp.dest("./vendors/quill"));
  var map12 = gulp
    .src("node_modules/jquery-bar-rating/dist/jquery.barrating.min.js.map")
    .pipe(gulp.dest("./vendors/jquery-bar-rating"));
